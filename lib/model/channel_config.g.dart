...
ProjectConfig _$ProjectConfigFromJson(
  ...
  tencentConfig: TencentConfig.fromJson(
    json['tencentConfig'] as Map<String, dynamic>,
  ),
  honorConfig: HonorConfig.fromJson(
    json['honorConfig'] as Map<String, dynamic>,
  ),
);
...
XiaomiConfig _$XiaomiConfigFromJson(Map<String, dynamic> json) =>
    XiaomiConfig(
        ...
        packageName: json['packageName'] as String? ?? "",
        channel:
            $enumDecodeNullable(_$ChannelEnumEnumMap, json['channel']) ??
            ChannelEnum.xiaomi,
        noteUrl:
...
HonorConfig _$HonorConfigFromJson(Map<String, dynamic> json) =>
    HonorConfig(
        ...
        noteUrl:
            json['noteUrl'] as String? ??
            "https://developer.honor.com/cn/doc/guides/101359",
      )
      ..isEnable = json['isEnable'] as bool
      ..isSuccess = json['isSuccess'] as bool?
      ..auditInfo = json['auditInfo'] == null
...
Map<String, dynamic> _$HonorConfigToJson(HonorConfig instance) =>
    <String, dynamic>{
      'channel': _$ChannelEnumEnumMap[instance.channel]!,
      'packageName': instance.packageName,
      'isEnable': instance.isEnable,
...
Map<String, dynamic> _$VivoConfigToJson(VivoConfig instance) =>
    <String, dynamic>{
      'channel': _$ChannelEnumEnumMap[instance.channel]!,
      'packageName': instance.packageName,
      'isEnable': instance.isEnable,
...
Map<String, dynamic> _$OppoConfigToJson(OppoConfig instance) =>
    <String, dynamic>{
      'channel': _$ChannelEnumEnumMap[instance.channel]!,
      'packageName': instance.packageName,
      'isEnable': instance.isEnable,
...
Map<String, dynamic> _$TencentConfigToJson(TencentConfig instance) =>
    <String, dynamic>{
      'channel': _$ChannelEnumEnumMap[instance.channel]!,
      'packageName': instance.packageName,
      'isEnable': instance.isEnable,
...
UploadApkInfo _$UploadApkInfoFromJson(Map<String, dynamic> json) =>
    UploadApkInfo(
...
Map<String, dynamic> _$UploadApkInfoToJson(UploadApkInfo instance) =>
    <String, dynamic>{
